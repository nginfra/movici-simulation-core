...
def main():
    ...
    badge_color = "brightgreen" if coverage_percent >= 90 else \
                  "green" if coverage_percent >= 80 else \
                  "yellow" if coverage_percent >= 70 else \
                  "orange" if coverage_percent >= 60 else "red"

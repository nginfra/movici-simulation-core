...
from movici_simulation_core.core.data_format import dump_update
...
from movici_simulation_core.core.data_format import load_update
...
class UpdateDataService(Service):
    ...
    @classmethod
    def install(cls, simulation: Simulation):
        simulation.register_service("update_data", cls, auto_use=True)
